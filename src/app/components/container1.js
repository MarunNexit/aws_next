  ...
  return (
    <div className={styles.frameParent}>
      <div className={styles.parent}>
        <b className={styles.b}>Історія матеріалів</b>
        <div className={styles.frameGroup}>
          ...
          <div className={styles.largenormaljustifyactiveContainer}>
            <button className={styles.largenormaljustifyactive1}>
              <b className={styles.b2}>Дата</b>
              <img className={styles.image8Icon} alt="" src="/image-8@2x.png" />
            </button>
          </div>
        </div>
      ...
      <div className={styles.group}>
        ...
        <b className={styles.div}>Редагування</b>
      </div>
